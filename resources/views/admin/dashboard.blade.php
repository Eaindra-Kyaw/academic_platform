...
@section('sidebar')
    ...
    <a href="/admin/dashboard" class="nav-item active"><i class="bi bi-grid-1x2-fill"></i><span>Dashboard</span></a>
    <a href="/admin/users" class="nav-item"><i class="bi bi-people"></i><span>User Management</span></a>
    <a href="/admin/departments" class="nav-item"><i class="bi bi-building"></i><span>Departments</span></a>
    <a href="/admin/courses" class="nav-item"><i class="bi bi-book"></i><span>Course Management</span></a>

...
@section('welcome-text', 'View all attendance records across the university')
...
@section('content')
    ...
    <div class="filter-bar">
        <form method="GET" style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center; width: 100%;">
            ...
            <a href="{{ route('admin.attendance.records') }}" class="btn-filter"
                ...
                <tbody>
                    @foreach ($records as $record)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.students.show', $record->student->id) }}" class="student-link">
                            ...
                            <td>{{ $record->session->course->department->name ?? 'N/A' }}</td>

...
@section('welcome-text', 'Create a new course')
...
@section('content')
    ...
    <div class="form-card">
        <h3 style="color: #800000; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.5rem;">
            <i class="bi bi-book"></i> Create New Course
        </h3>
        ...
        <form method="POST" action="{{ route('admin.courses.store') }}">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="course_code" value="{{ old('course_code') }}" placeholder="e.g., CS301"
                        required>
                    @error('course_code')
                ...
                <div class="form-group">
                    ...
                    <select name="year" required>
                        ...
                        <option value="Second Year" {{ old('year') == 'Second Year' ? 'selected' : '' }}>Second Year
                        </option>
                        <option value="Third Year" {{ old('year') == 'Third Year' ? 'selected' : '' }}>Third Year</option>
                        <option value="Fourth Year" {{ old('year') == 'Fourth Year' ? 'selected' : '' }}>Fourth Year
                        </option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="academic_year"
                        value="{{ old('academic_year', date('Y') . '-' . (date('Y') + 1)) }}" placeholder="e.g., 2024-2025"
                        required>
                ...
                <div class="form-group">
                    <label>Room</label>
                    <input type="text" name="room" value="{{ old('room') }}" placeholder="e.g., Room A-203">
                    @error('room')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>

...
@section('welcome-text', $course->department->name ?? 'N/A')
...
@section('content')
    <style>
        ...
        .course-detail-card .header .badge-status {
        ...
        .course-detail-card .header .badge-status.active {
            background: #ecfdf5;
            color: #10b981;
        }

        .course-detail-card .header .badge-status.inactive {
            background: #fef2f2;
            color: #ef4444;
        }
    ...
    <!-- ===== BACK LINK ===== -->
    <a href="{{ route('admin.courses.index') }}" class="back-link-course">
        <i class="bi bi-arrow-left"></i> Back to Courses
    </a>

    <!-- ===== ACTION BUTTONS ===== -->
    <div class="action-bar-course">
        <a href="{{ route('admin.courses.edit', $course) }}" class="btn-action-course btn-action-course-edit">
    ...
    <div class="course-detail-card">
        <div class="header">
            ...
            <span class="badge-status {{ $course->is_active ? 'active' : 'inactive' }}">
        ...
        <div class="body">
            <div class="info-item">
                ...
                <span class="value">{{ $course->department->name ?? 'N/A' }}
                    ({{ $course->department->code ?? 'N/A' }})</span>
            </div>
            <div class="info-item">

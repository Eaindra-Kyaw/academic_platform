...
<body>
    <div class="container">
        ...
        <footer class="footer">
            <p class="note">
                <i class="bi bi-info-circle icon"></i> Existing user? Please select your role above to login. For
                account inquiries, contact <span class="dept">CEIT Department</span>.
            </p>
            <p class="copyright">

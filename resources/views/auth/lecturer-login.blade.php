...
<body>
    <div class="card">
        ...
        <div class="role-badge"><i class="bi bi-person-badge"></i> Lecturer Login</div>
        @if ($errors->any())
        ...
        <div class="test-users"><strong>Test Account:</strong><br>phyothuzartun@mtu.edu.mm / phyo123</div>
